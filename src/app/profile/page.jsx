...
const page = () => {
    ...
    return (
        <div className='flex '>
            <Sidebar />
            <div className='bg-[#EAECFE] flex flex-col w-full px-5 gap-7 h-full'>
                ...
                <div>
                    {general &&
                        <div className='flex w-full gap-5'>
                            <div className='bg-[#FFF] p-3 rounded-md flex flex-col gap-5'>
                                ...
                                <div className='flex gap-3'>
                                    <div>
                                        ...
                                        <div className='w-[360px] rounded-md'>
                                    ...
                                    <div>
                                        ...
                                        <div className='border-[#EAEAEA] w-[360px] border-[2px] rounded-md p-2 flex justify-between relative' onClick={() => setOpenCalendar(!opencalendar)}>
                                            <span>06/08/2023</span>
                                            <CalendarMonthIcon color='gray' sx={{ width: '20px', height: '20px', cursor: 'pointer' }} />
                                            <div className='z-20 absolute bg-[#FFF] top-14'>
                                                {opencalendar &&
                                ...
                                <div className='flex flex-col justify-center px-3 py-7 gap-7'>
                                    ...
                                    <div className='flex flex-col gap-5'>
                                        <div className='flex gap-2'>
                                            ...
                                            <span className='text-[16px] text-[#A0A0A0] font-semibold font-poppins leading-[24px] text-right'>darpan bahadur</span>
                                        </div>
                                        <div className='flex gap-2'>
                                            <span className='text-[16px] text-[#000] font-semibold font-poppins leading-[24px] w-[135px]'>Registration No.:</span>
                                            <span className='text-[16px] text-[#A0A0A0] font-semibold font-poppins leading-[24px]'>342</span>
                                        </div>
                                        <div className='flex gap-2'>
                                            <span className='text-[16px] text-[#000] font-semibold font-poppins leading-[24px] '>Email:</span>
                                            <span className='text-[16px] text-[#A0A0A0] font-semibold font-poppins leading-[24px]'>darpanbahadur123@gmail.com</span>
                                        </div>
                                        <div className='flex gap-2'>
                                            <span className='text-[16px] text-[#000] font-semibold font-poppins leading-[24px] '>Phone:</span>
                                            <span className='text-[16px] text-[#A0A0A0] font-semibold font-poppins leading-[24px]'>7894561230</span>
                                        </div>
                                        <div className='flex gap-2'>
                                            <span className='text-[16px] text-[#000] font-semibold font-poppins leading-[24px] '>Gender:</span>
                                            <span className='text-[16px] text-[#A0A0A0] font-semibold font-poppins leading-[24px]'>Male</span>
                                        </div>
                                        <div className='flex gap-2'>
                                            <span className='text-[16px] text-[#000] font-semibold font-poppins leading-[24px] '>DOB:</span>
                                            <span className='text-[16px] text-[#A0A0A0] font-semibold font-poppins leading-[24px]'>14/12/2023</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
