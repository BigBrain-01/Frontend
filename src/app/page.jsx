    ...
    <div className="flex flex-col gap-[5rem]">
      ...
      <div className="flex py-5">
        <div className="relative w-[50%] ">
          <Image
            ...
            width={'130'}
            height={'200'}
            className="absolute left-[12rem] top-[1rem]"
          />
          <Image
            src={'/choose1.png'}
            width={'130'}
      ...
      <div className="px-32 flex flex-col gap-10 relative">
        ...
        <div className="w-full overflow-hidden">
          <div
            className="flex whitespace-nowrap gap-7 items-center transition duration-[1000] ease"
          ...
          <div className="flex justify-evenly">
            {plan.map((value, i) => (
              <Paper
                elevation={3}
                key={i}
                className="flex flex-col items-center w-[300px]  py-1 px-1 gap-3"
