    ...
    <div className='flex flex-col font-poppins overflow-y-hidden'>
      ...
      <div className='flex flex-col gap-[5rem]'>
        ...
        <div className='px-32 flex flex-col justify-center' id='about'>
          <div className='flex justify-between'>
            <div className='flex flex-col'>
              <span className='text-[20px] text-[#0015C8] font-bold  font-poppins leading-normal'>About Us</span>
              <div className='text-4xl  font-poppins text-[#18191F] font-[800] leading-normal'>An <span className='relative' >Easier
        ...
        <div className='flex py-5 mt-[3.5rem]'>
          ...
          <div className='flex flex-col gap-3 '>
            <div className='flex items-center gap-2'>
              ...
              <h1 className='text-[#757575] text-[17px] font-semibold  font-poppins leading-normal'>Why Choose Us</h1>
            </div>
            <div className='flex flex-col gap-5'>
              <span className='text-[#18191F] text-[35px]  font-poppins font-semibold leading-normal'>We deliver great service<br /> with  outstanding value</span>
              <div className='flex gap-3'>
                ...
                <div>
                  <h1 className='text-[#18191F] text-[18px]  font-poppins leading-normal font-semibold'>Fast working process</h1>
                  <span className='text-[16px] text-[#757575] font-semibold  font-poppins'>At studytitans provide fast placed development, <br />with flexible collaboration & payments</span>
                </div>
              </div>
              <div className='flex gap-3'>
                ...
                <div>
                  <h1 className='text-[#18191F] text-[18px]  font-poppins leading-normal font-semibold'>Dedicated team</h1>
                  <span className='text-[16px] text-[#757575] font-semibold  font-poppins'>At studytitans provide fast placed development, <br />with flexible collaboration & payments</span>
                </div>
              </div>
              <div className='flex gap-3'>
                ...
                <div>
                  <h1 className='text-[#18191F] text-[18px]  font-poppins leading-normal font-semibold'>24/7 hours support</h1>
                  <span className='text-[16px] text-[#757575] font-semibold  font-poppins'>At studytitans provide fast placed development, <br />with flexible collaboration & payments</span>
                </div>
              </div>
            </div>
        ...
        <div className='px-32 flex flex-col gap-10 relative'>
          <div className='flex flex-col'>
            <span className='text-[20px] text-[#0015C8] font-bold  font-poppins leading-normal'>Featured Videos</span>
            <span className='text-4xl  font-poppins text-[#18191F] font-[800]'>Community Programs</span>
          </div>
          <div className='w-full overflow-hidden'>
            <div className='flex whitespace-nowrap gap-4 items-center transition duration-[1000] ease' style={{ transform: `translate3d(${-slideIndex * 100}%, 0, 0)` }}>
              {data.map((value, i) => (
                <Paper elevation={1} key={i} sx={{ display: 'inline-block', gap: '5px', flexDirection: 'column' }} className={`min-w-[400px] `}>
                  ...
                  <div className='flex justify-between px-3'>
                    <div className='flex flex-col '>
                      <span className='text-[20px] text-[#000000] font-bold  font-poppins'>{value.class}</span>
        ...
        <div className='flex flex-col'>
          ...
          <div className='bg-[#00693B] w-full flex items-center justify-center p-10'>
            <div className='flex flex-col gap-9'>
              <div className='flex flex-col items-center justify-center'>
                <h1 className='text-[40px] text-[#FFFFFF]  font-poppins font-bold'>Some count that matters</h1>
                <span className='text-[#FFFFFF] text-[18px]  font-poppins font-medium'>Our achievement in the journey depicted in numbers</span>
              </div>
              <div className='flex gap-10'>
                <div className='flex flex-col items-center'>
                  <h1 className='text-[48px] text-[#FFFFFF]  font-poppins font-bold'>5</h1>
                  <span className='text-[18px] text-[#FFFFFF]  font-poppins font-medium'>Service Geographics</span>
                </div>
                <hr className='bg-[#FFFFFF] h-[6rem] w-[1px]' />
                <div className='flex flex-col items-center'>
                  <h1 className='text-[48px] text-[#FFFFFF]  font-poppins font-bold'>30</h1>
                  <span className='text-[18px] text-[#FFFFFF]  font-poppins font-medium'>Fortune 500 Clients</span>
                </div>
                <hr className='bg-[#FFFFFF] h-[6rem] w-[1px]' />
                <div className='flex flex-col items-center'>
                  <h1 className='text-[48px] text-[#FFFFFF]  font-poppins font-bold'>300</h1>
                  <span className='text-[18px] text-[#FFFFFF]  font-poppins font-medium'>Dedicated Members</span>
                </div>
                <hr className='bg-[#FFFFFF] h-[6rem] w-[1px]' />
                <div className='flex flex-col items-center'>
                  <h1 className='text-[48px] text-[#FFFFFF]  font-poppins font-bold'>8</h1>
                  <span className='text-[18px] text-[#FFFFFF]  font-poppins font-medium'>Years of Journey</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className='flex flex-col px-32 gap-5 bg-[#EAECFE] py-10'>
            <div className='flex flex-col items-center'>
              <h1 className='text-[43px] text-[#000000]  font-poppins font-bold mt-[2rem] '>Subscription Plans</h1>
              <span className='text-[14px] text-[#000000]  font-poppins font-semibold'>Our achievement in the journey depicted in numbers</span>
            </div>
            <div className='flex justify-evenly'>
              {plan.map((value, i) => (
                <Paper elevation={3} key={i} className='flex flex-col items-center w-[300px]  py-1 px-1 gap-3 hover:scale-[108%]' sx={{ borderRadius: "12px" }}>
                  <Image src={value.img} width={'300'} height={'165'} />
                  <h1 className='text-[30px]  font-poppins font-bold text-[#FFD600]'>{value.class}</h1>
                  <span className='text-[30px] text-[#000000]  font-poppins font-bold leading-normal'>$50 USD</span>
                  <div className='flex flex-col text-[12px] text-[#3B3B3B]  font-poppins font-semibold leading-[14.5px] items-center gap-2'>
                  ...
                  <button className='bg-[#00693B] p-3 rounded-md text-[14px] text-[#FFFFFF]  font-poppins mt-10 px-5'>Buy Now</button>
                  <div className='bg-[#F4F4F4] w-full p-[3px] h-[47px] items-center flex justify-center  font-poppins text-[12px] text-[#3B3B3B] rounded-xl'>
        ...
        <div className='flex flex-col items-center gap-3 h-max pb-16 '>
          <div className='mb-10'>
            <h1 className='text-[43px] text-[#000000]  font-poppins leading-normal font-bold '>Frequently Asked Questions</h1>
          </div>
            ...
            {question.map((value, i) => (
              <div className='flex flex-col w-[1182px] ' key={i}>
                <Paper elevation={0} className='flex justify-between  p-3 items-center'>
                  <span className='text-[18px]  font-poppins font-bold text-[#000000] leading-normal px-5'>{value.question}</span>
                ...
                {showans && (value.id === quesid) &&
                  <div className='bg-[#ECECEC] p-3 px-8 '>
                    <span className='text-[16px] text-[#757575]  font-poppins font-semibold leading-normal '>{value.ans}</span>
                  </div>
                }
              </div>
            ))}
