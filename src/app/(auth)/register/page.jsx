...
const Register = () => {
    ...
    return (
        <div className='flex justify-between'>
            ...
            <div className='flex flex-col px-20 w-[70%] font-poppins items-center justify-center gap-5'>
                ...
                <button onClick={() => signIn("google")} className='flex gap-2 px-4 py-0.5 items-center justify-center border-[1.4px] border-[#D2D2D2] text-[#043133] text-sm leading-normal font-medium'>
