    ...
    <div className='flex '>
      ...
      <div className='w-[70%] items-center justify-center flex flex-col gap-3'>
        ...
        <div className='flex flex-col items-center justify-center w-1/2'>
          <form onSubmit={handleSignIn} className="flex flex-col w-full gap-8 items-center justify-center">
            <div className='flex flex-col w-full'>
              ...
              })} placeholder="Enter your email here" className=' w-full bg-[#EFF0F2] p-3  placeholder:text-[#838383] placeholder:leading-normal' style={{ outline: 'none', border: 'none' }} />
            </div>
            <div className='flex flex-col w-full'>
              ...
              <div className='w-full bg-[#EFF0F2] p-3 flex justify-between'>
                <input type={show ? "password" : "text"} onChange={(e) => setFormData({
                  ...formData,
                  password: e.target.value
                })} placeholder="Enter your password" className=' placeholder:text-[#838383] placeholder:leading-normal bg-[#EFF0F2]' style={{ outline: 'none', border: 'none', width: '90%' }} />
            ...
            <div className='flex flex-col gap-3'>
              <button type='submit' className='w-max px-24 py-2 bg-[#007074] text-[#FFFFFF] text-[20px] font-medium font-poppins leading-normal' >Login</button>
            ...
            <div className='flex flex-col items-center gap-3'>
              ...
              <button onClick={() => signIn("google")} type='button' className='flex gap-2 px-4 py-2 items-center justify-center border-[1.4px] border-[#D2D2D2] text-[#043133] text-sm leading-normal font-medium'>
